...
let        
    ...
    nestedPackages = [
        definitions.mainPackages.openssl
        definitions.mainPackages.unixtools.arp      # security flaws in openssl-1.0.2u, TODO: make a fixed version with overrides
        definitions.mainPackages.unixtools.ifconfig # security flaws in openssl-1.0.2u, TODO: make a fixed version with overrides
        definitions.mainPackages.unixtools.netstat  # security flaws in openssl-1.0.2u, TODO: make a fixed version with overrides
        definitions.mainPackages.unixtools.ping     # security flaws in openssl-1.0.2u, TODO: make a fixed version with overrides
        definitions.mainPackages.unixtools.route    # security flaws in openssl-1.0.2u, TODO: make a fixed version with overrides
